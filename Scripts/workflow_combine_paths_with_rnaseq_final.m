...
% table_DNA_kegg_RNA_sub_prod_products_bestcorr_genes_pos.csv
% table_DNA_kegg_RNA_sub_prod_products_bestcorr_EC_pos.csv
% Figures:
...
corrtable = array2table(kegg_DNA_sub_prod_products_bestcorrP_pos,...
    ...
    'VariableNames', species_list);
writetable(corrtable, ...
    [outputFolder, 'table_DNA_kegg_sub_prod_products_bestcorrP_pos.csv'],...
    'WriteRowNames',true);
% enzymes
...
corrtable = cell2table(corrtable,...
    ...
    'VariableNames', species_list);
writetable(corrtable, ...
    [outputFolder, 'table_DNA_kegg_RNA_sub_prod_products_bestcorr_genes_pos.csv'],...
    'WriteRowNames',true);
corrtableEC = cell2table(corrtableEC,...
    'RowNames', kegg_sub_prod_products_unique,...
    'VariableNames', species_list);
writetable(corrtableEC, ...
    [outputFolder, 'table_DNA_kegg_RNA_sub_prod_products_bestcorr_EC_pos.csv'],...
    'WriteRowNames',true);
