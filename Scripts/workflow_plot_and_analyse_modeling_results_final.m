...
load([outputFolder 'cgo_clustergrams_model_DC_combined_IP_LIPPCwhighTotalPCC.mat']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
print(gcf, '-vector', '-dpdf', '-r600', '-bestfit',...
    ...
    sel_crit1, '_', sel_crit2,'corr_0_7.pdf']])
...
print(gcf, '-vector', '-dpdf', '-r600', '-bestfit',...
            [figureFolder,...
            'fig4c_clustergram_PTWENR_hcluster_combined_sol_hmdbCombinedClasses_2LIhos1LIbact_pFDR_le0_1.pdf'])
...
print(gcf, '-vector', '-dpdf', '-r600', '-bestfit',...
            [figureFolder,...
            'fig4c_clustergram_PTWENR_hcluster_combined_sol_',...
