...
mycolors = [0 115 178;... %dark blue
            ...
            246 223 212 %light orange
            ]/256;

mycoloroptions = {{'MarkerFaceColor', [0 115 178]/256,'MarkerEdgeColor', 'none'},... %dark blue face
                  {'MarkerFaceColor', 'none','MarkerEdgeColor', [0 115 178]/256},... %dark blue edge
                  {'MarkerFaceColor', [211 96 39]/256,'MarkerEdgeColor', 'none'},... %dark orange face
                  {'MarkerFaceColor', 'none','MarkerEdgeColor', [211 96 39]/256},... %dark orange edge
                  };
            ...
            switch type_i
                case 3
                    scatter(coeff(cursamples,1),coeff(cursamples,2),...
                            markersize,...
                            mymarkers{tissue_i},...
                            mycoloroptions{coloridx}{:});%'MarkerFaceColor', mycolors(coloridx,:),...
                ...
                case 2
                    scatter(coeff(cursamples,1),coeff(cursamples,2),...
                            markersize,...
                            mymarkers{tissue_i},...
                            mycoloroptions{coloridx}{:});%'MarkerFaceColor', mycolors(coloridx,:),...[1 1 1],...
                            %'MarkerEdgeColor', 'none');%mycolors(coloridx,:));
            end
        end
        coloridx = coloridx+1;
...
print(gcf, '-painters', '-dpdf', '-r600', '-bestfit', ...
         [figureFolder...
         'fig2b_pca_metabolomics_all_annotated_ions_updated_metfilter_lognorm_Impute5000_coloredgeface'])
...
for tissue_i = 1:length(pca_tissue_unique)
    ...
    print(gcf, '-painters', '-dpsc', '-r600', '-bestfit', ...
              '-append',...
              [figureFolder...
              'fig2b_sup_pca_metabolomics_per_tissue_annotated_ions_updated_metfilter_lognorm_Impute5000_coloredgeface'])
    clf
end
